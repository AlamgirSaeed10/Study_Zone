 ...
 */
public class FilterCriteriaFragmentOneYear extends Fragment {
    ...
    public FilterCriteriaFragmentOneYear() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LocalDateTime fromLocalDate = LocalDateTime.now().minusYears(1);
