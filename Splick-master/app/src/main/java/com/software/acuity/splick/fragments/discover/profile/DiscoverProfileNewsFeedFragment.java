 ...
 */
public class DiscoverProfileNewsFeedFragment extends Fragment implements IVolleyResponse {
    ...
    public DiscoverProfileNewsFeedFragment() {
    }

    public DiscoverProfileNewsFeedFragment(Business businessItem) {
...
//                        intent.putExtra("post_obj", postList.get(position));
//                        intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
...
//                Toast.makeText(getActivity(), "Item Long Clicked", Toast.LENGTH_SHORT).show();
    ...
    public void requestData() {
        ...
        try {
            ...
            userId = this.businessItem.getId();


            if (userObject.getString("user_role").trim().equalsIgnoreCase("affiliate")) {

                params.put("business_id", userId + "");
                volleyRequestClass = new VolleyRequestClass(getActivity(),
                        DiscoverProfileNewsFeedFragment.this,
