 ...
 */
public class FilterCriteriaFragmentOneMonth extends Fragment {
    ...
    public FilterCriteriaFragmentOneMonth() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LocalDateTime fromLocalDate = LocalDateTime.now().minusMonths(1);
