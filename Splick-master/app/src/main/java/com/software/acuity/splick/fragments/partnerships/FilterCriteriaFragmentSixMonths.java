 ...
 */
public class FilterCriteriaFragmentSixMonths extends Fragment {
    ...
    public FilterCriteriaFragmentSixMonths() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LocalDateTime fromLocalDate = LocalDateTime.now().minusMonths(6);
