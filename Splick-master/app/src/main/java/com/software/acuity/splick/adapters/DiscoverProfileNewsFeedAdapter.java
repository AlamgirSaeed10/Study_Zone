...
public class DiscoverProfileNewsFeedAdapter extends RecyclerView.Adapter<DiscoverProfileNewsFeedAdapter.MyVIewHolder> {

    List<PortfolioModel> mDataList = new ArrayList<>();
    Context context;
    LayoutInflater layoutInflater;

    public DiscoverProfileNewsFeedAdapter(Context context, List<PortfolioModel> mDataList) {
